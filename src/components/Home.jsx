  ...
  return (
    <div name="home" className='mx-auto pt-20 flex-col justify-center w-full h-full'>
        ...
        {/* <ul className='align-middle font-bold'> */}
            ...
            <div id="home_main" className="lg:flex-1 lg:my-auto px-2 mx-auto lg:pl-24 sm:mx-8 ">
            ...
            <div id="home-bottom-container" className="lg:flex-1 lg:my-auto px-2 lg:pt-0 mx-auto lg:pl-24 sm:mx-8 lg:w-[1000px]"> 
