...
const Calculators = () => {
  return (
    ...
    <div name="calculators" className='max-w-[1000px] mx-auto p-4 flex-col justify-center w-full h-full'>
        {/* <h2 className='lg:text-2xl font-bold text-center pt-4 pb-2 align-middle'>Mortgage Calculators</h2> */}
        <p className='pb-2 text-left'>What is a mortgage going to cost you each month?  Give me a call and I will work out the numbers for you and email them over OR try one of the calculators below to get a quick idea.</p>
        <div className="grid sm:grid-cols-2 md:grid-cols-2 gap-4">
        {/* <ul className='align-middle font-bold'> */}
            <span id="resource-id" className='my-2 border p-2 pt-4 rounded hover:border-blue-600 duration-300'>
